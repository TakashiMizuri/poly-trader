...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full min-w-0 items-center gap-2 rounded-lg border border-border bg-input px-3 text-sm text-foreground shadow-none transition-colors outline-none select-none",
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          {...props}
        >
          <SelectPrimitive.List className="overflow-y-auto p-0">{children}</SelectPrimitive.List>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
    </SelectPrimitive.Portal>
  )
